...
public class MainActivity extends AppCompatActivity {
    ...
    ArrayList<String> phone_id, phone_name, phone_number, phone_description;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customAdapter = new CustomAdapter(MainActivity.this,this, phone_id, phone_name, phone_number,
                phone_description);
